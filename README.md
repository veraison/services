...
For a native deployment, there are additional dependencies to the ones listed
in the "requirements" section above. We have bootstrap scripts for Ubuntu and
Arch that ensure that the required dependencies are installed.
