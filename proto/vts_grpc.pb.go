...
type VTSClient interface {
	...
	SetEndorsementsActive(ctx context.Context, in *SetEndorsementsActiveRequest, opts ...grpc.CallOption) (*SetEndorsementsActiveResponse, error)
...
func (c *vTSClient) SetEndorsementsActive(ctx context.Context, in *SetEndorsementsActiveRequest, opts ...grpc.CallOption) (*SetEndorsementsActiveResponse, error) {
	out := new(SetEndorsementsActiveResponse)
	err := c.cc.Invoke(ctx, "/proto.VTS/SetEndorsementsActive", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type VTSServer interface {
	...
	SetEndorsementsActive(context.Context, *SetEndorsementsActiveRequest) (*SetEndorsementsActiveResponse, error)
	// Returns the public key used to sign evidence.
...
func (UnimplementedVTSServer) SetEndorsementsActive(context.Context, *SetEndorsementsActiveRequest) (*SetEndorsementsActiveResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetEndorsementsActive not implemented")
}
...
func _VTS_SetEndorsementsActive_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetEndorsementsActiveRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VTSServer).SetEndorsementsActive(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.VTS/SetEndorsementsActive",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VTSServer).SetEndorsementsActive(ctx, req.(*SetEndorsementsActiveRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var VTS_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SetEndorsementsActive",
			Handler:    _VTS_SetEndorsementsActive_Handler,
		},
		{
