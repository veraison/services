...
func (c *vTSClient) GetCompositeAttestation(ctx context.Context, in *AttestationToken, opts ...grpc.CallOption) (*AppraisalContext, error) {
	out := new(AppraisalContext)
	err := c.cc.Invoke(ctx, "/proto.VTS/GetCompositeAttestation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _VTS_GetCompositeAttestation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AttestationToken)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VTSServer).GetCompositeAttestation(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.VTS/GetCompositeAttestation",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VTSServer).GetCompositeAttestation(ctx, req.(*AttestationToken))
	}
	return interceptor(ctx, in, info, handler)
}
...
var VTS_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _VTS_GetCompositeAttestation_Handler,
		},
		{
