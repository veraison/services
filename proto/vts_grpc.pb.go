...
type VTSClient interface {
	...
	SetEndorsementsState(ctx context.Context, in *SetEndorsementsStateRequest, opts ...grpc.CallOption) (*SetEndorsementsStateResponse, error)
...
func (c *vTSClient) SetEndorsementsState(ctx context.Context, in *SetEndorsementsStateRequest, opts ...grpc.CallOption) (*SetEndorsementsStateResponse, error) {
	out := new(SetEndorsementsStateResponse)
	err := c.cc.Invoke(ctx, "/proto.VTS/SetEndorsementsState", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type VTSServer interface {
	...
	SetEndorsementsState(context.Context, *SetEndorsementsStateRequest) (*SetEndorsementsStateResponse, error)
	// Returns the public key used to sign evidence.
...
func (UnimplementedVTSServer) SetEndorsementsState(context.Context, *SetEndorsementsStateRequest) (*SetEndorsementsStateResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetEndorsementsState not implemented")
}
...
func _VTS_SetEndorsementsState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetEndorsementsStateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VTSServer).SetEndorsementsState(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.VTS/SetEndorsementsState",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VTSServer).SetEndorsementsState(ctx, req.(*SetEndorsementsStateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var VTS_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SetEndorsementsState",
			Handler:    _VTS_SetEndorsementsState_Handler,
		},
		{
