...
type VTSClient interface {
	...
	GetAttestation(ctx context.Context, in *AttestationToken, opts ...grpc.CallOption) (*Attestation, error)
...
func (c *vTSClient) GetAttestation(ctx context.Context, in *AttestationToken, opts ...grpc.CallOption) (*Attestation, error) {
	out := new(Attestation)
...
type VTSServer interface {
	// Returns attestation information -- evidences, endorsed claims, trust
	// vector, etc -- for the provided attestation token data.
	GetAttestation(context.Context, *AttestationToken) (*Attestation, error)
	// Service endpoints that are used to store Software Components
	// and Trust Anchors to the endorsement store
...
func (UnimplementedVTSServer) GetAttestation(context.Context, *AttestationToken) (*Attestation, error) {
