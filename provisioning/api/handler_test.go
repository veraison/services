...
func TestHandler_SetActive_UnsupportedMediaType(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
...
func TestHandler_SetActive_NoBody(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
...
func TestHandler_SetActive_ProvisionerFailure(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
