...
const (
	SupportedMediaType = `application/corim-unsigned+cbor; profile="tag:github.com/parallaxsecond/key-attestation,2022-11-04:tpm"`
	PluginName         = "unsigned-corim (PARSEC TPM Key Attestation profile)"
)
