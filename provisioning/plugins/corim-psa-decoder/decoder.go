...
const (
	SupportedMediaTypeP1 = "application/corim-unsigned+cbor; profile=PSA_IOT_PROFILE_1"
	SupportedMediaTypeP2 = "application/corim-unsigned+cbor; profile=http://arm.com/psa/2.0.0"
