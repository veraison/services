...
func (m *MockIBackend) Evaluate(ctx context.Context, appraisalContext map[string]interface{}, scheme, policy string, result, evidence map[string]interface{}, endorsements []string) (map[string]interface{}, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Evaluate", ctx, appraisalContext, scheme, policy, result, evidence, endorsements)
...
func (mr *MockIBackendMockRecorder) Evaluate(ctx, appraisalContext, scheme, policy, result, evidence, endorsements interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Evaluate", reflect.TypeOf((*MockIBackend)(nil).Evaluate), ctx, appraisalContext, scheme, policy, result, evidence, endorsements)
}
