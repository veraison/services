...
// SchemeImplementationWrapper provides an implementation of ISchemeHandler
// based on a SchemeDescriptor and a ISchemeImplementation implementation.
// The wrapper provides default implementations of some of the ISchemeHandler
// methods, and makes some others options. This saves attestations schemes from
// needing to implement the full ISchemeHandler interface.
