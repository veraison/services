...
func (o *JWTSigner) Init(cfg SignerCfg, fs afero.Fs) error {
...
func (o *JWTSigner) Close() error {
	return nil
}

func (o JWTSigner) Sign(earClaims ear.AttestationResult) ([]byte, error) {
	return earClaims.Sign(o.Alg, o.Key)
}

func (o *JWTSigner) setAlg(alg string) error {
...
func (o *JWTSigner) loadKey(fs afero.Fs, keyFile string) error {
	var (
		err error
		b   []byte
		k   jwk.Key
