...
func (o *GRPCServer) Init(v *viper.Viper, pm plugin.IManager[handler.IEvidenceHandler]) error {
	var err error
...
func (o *GRPCServer) GetServiceState(context.Context, *emptypb.Empty) (*proto.ServiceState, error) {
...
func (o *GRPCServer) AddRefValues(ctx context.Context, req *proto.AddRefValuesRequest) (*proto.AddRefValuesResponse, error) {
	var (
		err     error
		keys    []string
...
func (o *GRPCServer) AddTrustAnchor(
	ctx context.Context,
...
func (o *GRPCServer) GetAttestation(
	ctx context.Context,
...
func (c *GRPCServer) initEvidenceContext(
	handler handler.IEvidenceHandler,
	token *proto.AttestationToken,
) (*Appraisal, error) {
	var err error

	appraisal := NewAppraisal(token.TenantId)
...
func (c *GRPCServer) getTrustAnchor(id string) (string, error) {
...
func (c *GRPCServer) GetSupportedVerificationMediaTypes(context.Context, *emptypb.Empty) (*proto.MediaTypeList, error) {
