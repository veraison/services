...
func main() {
	...
	policyManager, err := trustedservices.NewPolicyManager(
		subs["po-agent"], poStore, log.Named("policy"))
	if err != nil {
	...
	earSigner, err := trustedservices.NewJWTSigner(subs["ear-signer"], afero.NewOsFs())
	if err != nil {
