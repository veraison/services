...
import (
	plugin_common "github.com/veraison/services/plugins/common"
	"github.com/veraison/services/provisioning/decoder"
)

const (
	SupportedMediaType = "application/corim-unsigned+cbor; profile=http://enacttrust.com/veraison/1.0.0"
	PluginName         = "unsigned-corim (TPM EnactTrust profile)"
)
