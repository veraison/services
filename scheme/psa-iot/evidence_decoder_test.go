...
func Test_GetTrustAnchorID_ok(t *testing.T) {
	...
	taID, err := decoder.GetTrustAnchorID(&token)
	require.NoError(t, err)
...
func Test_ExtractVerifiedClaimsInteg_ok(t *testing.T) {
	...
	_, err = decoder.ExtractClaims(&token, string(taEndValBytes))
...
func Test_ExtractVerifiedClaims_ok(t *testing.T) {
	...
	extracted, err := decoder.ExtractClaims(&token, string(taEndValBytes))
...
func Test_ValidateEvidenceIntegrity_ok(t *testing.T) {
	...
	err = decoder.ValidateEvidenceIntegrity(&token, string(taEndValBytes), nil)
...
func Test_AppraiseEvidence_ok(t *testing.T) {
	...
	attestation, err := decoder.AppraiseEvidence(&ec, []string{string(endorsementsBytes)})
	require.NoError(t, err)
...
func Test_AppraiseEvidenceMultEndorsement_ok(t *testing.T) {
	...
	attestation, err := decoder.AppraiseEvidence(&ec, endorsemementsArray)
	require.NoError(t, err)
