...
COMID_TEMPLATES=(
	ComidTpmEnactTrustAKOne
	ComidTpmEnactTrustGoldenOne
	ComidTpmEnactTrustAKMult
	ComidTpmEnactTrustBadInst
	ComidTpmEnactTrustNoInst
	ComidTpmEnactTrustMultDigest
	ComidTpmEnactTrustGoldenTwo
	ComidTpmEnactTrustNoDigest
	ComidTpmEnactTrustAKBadInst
)
