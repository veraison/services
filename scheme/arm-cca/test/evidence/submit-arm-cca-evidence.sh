...
set +e
echo "----> post"
curl -X POST -D - -H 'Content-Type: application/eat-collection; profile="http://arm.com/CCA-SSD/1.0.0"' --data-binary @cca-good.cbor http://localhost:8443/challenge-response/v1/"$session_path"
echo ""
echo ""
set -e
