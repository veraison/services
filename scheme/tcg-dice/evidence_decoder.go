...
func (s EvidenceDecoder) GetName() string {
	return "tcg-dice-evidence-handler"
}

func (s EvidenceDecoder) GetAttestationScheme() string {
	return SchemeName
}

func (s EvidenceDecoder) GetSupportedMediaTypes() []string {
	return EvidenceMediaTypes
}

func (s EvidenceDecoder) GetTrustAnchorID(token *proto.AttestationToken) (string, error) {
	return "dice://", nil
}

func (s EvidenceDecoder) SynthKeysFromRefValue(tenantID string, swComp *proto.Endorsement) ([]string, error) {
	return nil, errors.New("TODO")
}

func (s EvidenceDecoder) SynthKeysFromTrustAnchor(tenantID string, ta *proto.Endorsement) ([]string, error) {
	return nil, errors.New("TODO")
}

func (s EvidenceDecoder) ExtractClaims(
	token *proto.AttestationToken,
	trustAnchor string,
) (*decoder.ExtractedClaims, error) {
	...
	extracted := decoder.ExtractedClaims{
		ClaimsSet:   claims,
		ReferenceID: "dice://",
	}
...
func (s EvidenceDecoder) ValidateEvidenceIntegrity(
	token *proto.AttestationToken,
	trustAnchor string,
	endorsements []string,
) error {
...
func (s EvidenceDecoder) AppraiseEvidence(
