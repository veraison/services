...
func (o *Implementation) AppraiseClaims(
	...
	// Remove the overall attestation scheme name specific submod from the
	// result, as it is not used -- each SPDM device claims set in evidence
	// has a corresponding submod in the result.
