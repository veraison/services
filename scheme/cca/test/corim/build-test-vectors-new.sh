...
generate_go_test_vector () {
	echo "value of argument 4 = $4"
	echo "value of argument 3 = $3"
...
CORIM_REALM_TEMPLATE="corimCcaRealm.json"
...
CORIM_PLATFORM_TEMPLATE="corimCca.json"
...
generate_templates() {
	...
	do
		...
		printf "generated test vector for $1 \n\n"
	done
