...
# Generate endorsement lifecycle management (ELM) queries
def generate_endorsement_lifecycle_management_queries(test):
    ...
    for query_type in ["rv", "ta", "rim"]:
        ...
        gencmd = f"A={query_type} {corim_arg} O={GENDIR}/elm-queries/query-{query_type}.cbor bash gen-lifecycle-management-queries.sh"
