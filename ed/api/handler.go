...
import (
	...
	"github.com/veraison/services/ed/endorsementdistributor"
...
var (
	tenantID       = "0"
	EdApiMediaType = "application/vnd.veraison.coserv-result-set+cbor"
...
func (o Handler) CoservRequest(c *gin.Context) {
	...
	res, err := o.EndorsementDistibutor.GetEndorsements(tenantID, coservQuery, offered)
	o.respondToGet(c, EdApiMediaType, res, err)
}
