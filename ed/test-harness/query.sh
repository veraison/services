...
cat << EOF | diag2cbor.rb | base64url_encode
{
  ...
  / query /   1: {
    ...
    / environment-selector /  1: {
      / class / 0: [
        {
          / class-id /  0: 560(h'7f454c4602010100000000000000000003003e00010000005058000000000000')  / tagged-bytes /
        }
      ]
    }
  }
...
curl -kv https://localhost:11443/endorsement-distribution/v1/coserv/$q | jq .