...
func (ed *EndorsementDistributor) GetEndorsements(tenantID string, query string, resultSetMediaType string) ([]byte, error) {
	req := &proto.EndorsementQueryIn{Query: query, ResultSetMediaType: resultSetMediaType}
